...
public class TransactionsView extends VerticalLayout implements View {
	...
	private Table buildTable() {
		...
		table.setContainerDataSource(
				new TempTransactionsContainer(DashboardUI.getDataProvider().getRecentTransactions(200)));
	...
	void createNewReportFromSelection() {
		...
		DashboardUI.getDashboardEventbus().post(new TransactionReportEvent((Collection<Transaction>) table.getValue()));
	}
